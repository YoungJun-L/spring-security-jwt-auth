...
enum class ErrorType(
    ...
    // user
    USER_BAD_CREDENTIALS_ERROR(HttpStatus.UNAUTHORIZED, ErrorCode.E4011, "아이디 또는 비밀번호가 다릅니다.", LogLevel.INFO),
    USER_DUPLICATE_ERROR(HttpStatus.BAD_REQUEST, ErrorCode.E4002, "이미 존재하는 아이디입니다.", LogLevel.INFO),
    USER_LOCKED_ERROR(HttpStatus.FORBIDDEN, ErrorCode.E4031, "계정이 잠겼습니다.", LogLevel.WARN),
    USER_DISABLED_ERROR(HttpStatus.FORBIDDEN, ErrorCode.E4032, "이용이 제한된 유저입니다.", LogLevel.WARN),
    USER_NOT_FOUND_ERROR(HttpStatus.NOT_FOUND, ErrorCode.E4041, "계정이 존재하지 않습니다.", LogLevel.INFO),
